...
interface JsonEditorCardProps {
  ...
  formatJson: (data: string, setter: (value: string) => void, type: string) => void;
  handleJsonChange: (value: string, setter: (value: string) => void, type: string) => void;
      ...
      <div className="relative">
        <textarea
          ...
          className={`w-full min-h-[300px] p-4 rounded-lg border-2 font-mono text-sm leading-relaxed resize-y transition-colors ${
            ...
            editingAllowed
              ? (isValidJson(jsonData) ? 'focus:ring-2 focus:ring-offset-2 focus:ring-green-300' : 'focus:ring-2 focus:ring-offset-2 focus:ring-red-300')
              : ''
